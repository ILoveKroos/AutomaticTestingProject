...
public class Fail_Material_fileEmply {
	...
	public void selectMat() throws Exception {
		...
		JSONObject jsonObject = (JSONObject) parser.parse(new FileReader("D:\\emptyMaterial.json"));
	...
	public void checkCharacters() throws Exception {
		...
		JSONParser parser = new JSONParser();
		JSONObject jsonObject = (JSONObject) parser.parse(new FileReader("D:\\character.json"));
